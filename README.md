...
To evaluate our own guides, we´ve built the F1 Season Manager in CodeIgniter 3 and just used the guides to upgrade the website to CodeIgniter 4. You can find the previous Version in CodeIgniter 3 [here](https://github.com/FlorianNelles/CI3-Example_F1-Season-Manager).
